"""
Circular-import protection module: track the current analysis depth of files through reference counting
to avoid infinite recursion when analyzing module dependencies recursively.
"""
