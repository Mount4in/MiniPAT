var _typeof2 = require("../../@babel/runtime/helpers/typeof");
    module.exports = function() {
        ...
        __DEFINE__(1711542553241, function(require, module, exports) {
            // Load modules
            ...
            var map = {
                "./stringify": 1711542553242,
                "./parse": 1711542553244
            };
            return __REQUIRE__(map[modId], modId);
        });
        __DEFINE__(1711542553242, function(require, module, exports) {
            // Load modules
        ...
        __DEFINE__(1711542553243, function(require, module, exports) {
            // Load modules
            ...
            exports.merge = function(target, source, options) {
                ...
                if (_typeof2(source) !== 'object') {
                    if (Array.isArray(target)) {
                        target.push(source);
                    } else if (_typeof2(target) === 'object') {
                        target[source] = true;
                    } else {
        ...
        __DEFINE__(1711542553244, function(require, module, exports) {
            // Load modules
        ...
        return __REQUIRE__(1711542553241);
    }();
